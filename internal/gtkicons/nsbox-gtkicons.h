...
void nsbox_g_object_unref (void *actual_func,
                           void *object);
...
void nsbox_gtk_icon_theme_set_search_path (void         *actual_func,
                                           GtkIconTheme *icon_theme,
                                           const gchar  *path);

gint * nsbox_gtk_icon_theme_get_icon_sizes (void         *actual_func,
                                            GtkIconTheme *icon_theme,
                                            const gchar  *icon_name);

GtkIconInfo * nsbox_gtk_icon_theme_lookup_icon (void         *actual_func,
                                                GtkIconTheme *icon_theme,
                                                const gchar  *icon_name,
                                                gint          size,
                                                int           flags);

const gchar * nsbox_gtk_icon_info_get_filename (void        *actual_func,
